...
function openCart(cart){
	...
	if(cartData !== null){
		totalItems = '<table class="table table-bordered table-hover"><tr><th>Hitachi</th><th>thanks</th><th class="text-right"> you</th></tr>';
		for(var items in cartData){
			totalItems += '<tr>';
			for(var i = 0; i < cartData[items].length; i++){
		...
		cartCont.innerHTML = '<div class="alert alert-warning">your items</div>';
	}
	return false;
}
